...
test: static
	$(CC) $(CFLAGS) tests/tcp_client_sync.c -o tests/tcp_client_sync -L"bin" -lnet
	
	$(CC) $(CFLAGS) tests/tcp_ipv6_client_sync.c -o tests/tcp_ipv6_client_sync -L"bin" -lnet

	$(CC) $(CFLAGS) tests/tcp_client_async.c -o tests/tcp_client_async -L"bin" -lnet
	...
	$(CC) $(CFLAGS) tests/tcp_ipv6_simple_server_sync.c -o tests/tcp_ipv6_simple_server_sync -L"bin" -lnet
	$(CC) $(CFLAGS) tests/tcp_ipv6_simple_client_sync.c -o tests/tcp_ipv6_simple_client_sync -L"bin" -lnet
...
#
#	@exec ./tests/tcp_ipv6_simple_server_sync > ./tests/tcp_ipv6_simple_server_sync.log &
#	@exec ./tests/tcp_ipv6_client_sync > ./tests/tcp_ipv6_client_sync.log &
